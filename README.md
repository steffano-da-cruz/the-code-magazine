# The Code Magazine
![Product Preview](/assets/github/the-code-magazine-readme.png)

## 💻 About the project
A simple web page where the user can read about technology like a blog or magazine made using Flexbox and some pseudo-classes and position relative and absolute as well.  Dont't forget to give it a try on mobile because this web page is responsive!
